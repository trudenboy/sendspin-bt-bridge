...
**Период:** 1 января — 8 марта 2026 г. · **Всего коммитов:** ~580 · **Версии:** 1.0.0 → 2.13.0
...
| Выпущено версий | ~135 (v1.0.0 → v2.13.0) |
| Pull Requests | 54 |
...
## 8 марта 2026 — Мульти-бридж и сообщество (v2.12.1 → v2.13.0)
