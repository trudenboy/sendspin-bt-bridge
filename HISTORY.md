...
За 9 дней активной разработки проект прошёл путь от однофайлового скрипта с одной колонкой до production-ready решения с subprocess-изоляцией звука, нативной интеграцией в экосистему Music Assistant и Home Assistant, поддержкой мультирум-конфигураций с синхронизацией через MA syncgroup.
