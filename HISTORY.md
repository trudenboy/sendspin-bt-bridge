...
**1 января 2026** — репозиторий **создан** loryanstrant'ом (timezone коммитов: +1100, AEDT — Австралия). Это не форк в смысле ответвления чужого кода: trudenboy связался с автором, обсудил проект, получил заготовку и лишь 27 февраля взялся за него всерьёз.

История с 1 января унаследована от loryanstrant — 4 PR с улучшениями детекции разрыва BT. После передачи репозиторий **лежал без изменений ~57 дней**.
...
|--------|----------|----------------|
| 1 января | 14 | Начало (репозиторий от loryanstrant, +1100 AEDT) |
