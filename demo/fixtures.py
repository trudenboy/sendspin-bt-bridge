...
DEMO_DEVICES = [
    ...
    },
    {
        ...
        "static_delay_ms": 80,
        "static_delay_source": "manual_calibration",
...
DEMO_DEVICE_STATUS: dict[str, dict] = {
    "AA:BB:CC:DD:EE:01": {
        ...
        "reanchor_count": 5,
        "reanchor_count_5m": 1,
        "reanchor_count_30m": 3,
        "last_reanchor_at": 1012.4,
        "bt_codec_name": "sbc",
        "bt_reported_delay_ms": 187.5,
        "bt_delay_reporting_supported": True,
        "suggested_static_delay_ms": 188,
        "latency_suggestion_source": "bluez_delay_report",
        "latency_suggestion_confidence": "medium",
        "latency_suggestion_explanation": "Delay reported by the demo Bluetooth speaker through AVDTP.",
        "latency_suggestion_revision": "demo-living-room-1",
        "timing_metrics_available": True,
        "backend_output_latency_ms": 42.8,
        "buffered_audio_ms": 438.2,
        "playback_sync_error_ms": 3.4,
        "clock_synchronized": True,
        "clock_offset_ms": -1.7,
        "clock_uncertainty_ms": 0.8,
        "timing_sampled_at": "2026-07-17T13:00:00Z",
    ...
    "AA:BB:CC:DD:EE:02": {
        ...
        "reanchor_count": 112,
        "reanchor_count_5m": 7,
        "reanchor_count_30m": 19,
        "last_sync_error_ms": 286.4,
        "last_reanchor_at": 1021.8,
        "reanchoring": True,
        "bt_codec_name": "sbc",
        "bt_reported_delay_ms": 142.0,
        "bt_delay_reporting_supported": True,
        "suggested_static_delay_ms": 80,
        "latency_suggestion_source": "manual_calibration",
        "latency_suggestion_confidence": "high",
        "latency_suggestion_explanation": "Previously confirmed demo calibration for this device.",
        "latency_suggestion_revision": "demo-kitchen-1",
        "timing_metrics_available": True,
        "backend_output_latency_ms": 151.0,
        "buffered_audio_ms": 171.3,
        "playback_sync_error_ms": 286.4,
        "clock_synchronized": True,
        "clock_offset_ms": 2.3,
        "clock_uncertainty_ms": 7.6,
        "timing_sampled_at": "2026-07-17T13:00:00Z",
        "latency_double_count_risk": True,
    ...
    "AA:BB:CC:DD:EE:03": {
        ...
        "reanchor_count": 15,
        "reanchor_count_5m": 2,
        "reanchor_count_30m": 6,
        "last_reanchor_at": 998.1,
        "bt_codec_name": "aac",
        "bt_delay_reporting_supported": False,
        "suggested_static_delay_ms": 125,
        "latency_suggestion_source": "codec_fallback",
        "latency_suggestion_confidence": "low",
        "latency_suggestion_explanation": "Approximate demo starting point for the AAC codec.",
        "latency_suggestion_revision": "demo-studio-1",
        "timing_metrics_available": True,
        "backend_output_latency_ms": 58.1,
        "buffered_audio_ms": 312.0,
        "playback_sync_error_ms": 12.6,
        "clock_synchronized": True,
        "clock_offset_ms": 0.9,
