...
Набор тестов содержит **149 тестов** в 15 тест-файлах, покрывающих конфигурацию, маршрутизацию громкости, статус устройств, управление состоянием, аутентификацию и Ingress middleware.
