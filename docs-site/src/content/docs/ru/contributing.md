...
Набор тестов содержит **959+ тестов** в 18 тест-файлах, покрывающих конфигурацию, маршрутизацию громкости, статус устройств, управление состоянием, аутентификацию, Ingress middleware, BT-сервисы, процесс демона, интеграцию с MA и кулдаун сканирования.
