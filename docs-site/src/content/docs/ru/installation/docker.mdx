...
- На AMD64-хостах: CPU уровня [`x86-64-v2`](#базовый-уровень-cpu-x86_64) (SSE4.2 + POPCNT)
...
Непустой результат — мост запустится. Пустой — демон будет падать на каждом запуске; см. [Troubleshooting › CPU-baseline crash](/ru/troubleshooting/#сбой-по-базовому-уровню-cpu-sigill--signal4) для диагностики и путей решения.
