...
def test_auto_release_reconnect_warning_remains_issue_worthy():
    line = (
        "2026-03-17 23:42:00,000 - bluetooth_manager - WARNING - "
        "[Lenco LS-500 @ HAOS] 10 consecutive failed reconnects (threshold=10) — auto-releasing BT management"
    )
